...
var githubRepository = "gripewithroslyn";
var githubUrl = string.Format("https://github.com/{0}/{1}", githubOwner, githubRepository);
var solutionToBuild = "./src/Dhgms.GripeWithRoslyn.sln";
